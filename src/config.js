...
export default {
    ...
    API_COUNTRY_DETAIL_CATEGORY: (process.env.API_COUNTRY_DETAIL_CATEGORY) || 'map,strategy,security,mission,toolbox,document_repo'.split(','),
    API_COUNTRY_DETAIL_TYPES: (process.env.API_COUNTRY_DETAIL_TYPES) || 'link,file'.split(','),
    ...
    TABLE_COUNTRY_DETAILS: process.env.TABLE_COUNTRY_DETAILS || 'cognicity.country_details',

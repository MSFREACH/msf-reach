...
// Add some base tiles
/*
var NEmapboxTerrain = L.tileLayer('https://api.mapbox.com/styles/v1/msfhk/cj9t3um812mvr2sqnr6fe0h52/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibXNmaGsiLCJhIjoiY2pxdnp0N3E2MTBwZDQybWhtMGw2aWljYSJ9.I6nmYZcm6p77JgxlITRfpQ', {
...
var NEmapboxSatellite = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibXNmaGsiLCJhIjoiY2pxdnp0N3E2MTBwZDQybWhtMGw2aWljYSJ9.I6nmYZcm6p77JgxlITRfpQ', {
    attribution: '© Mapbox © OpenStreetMap © DigitalGlobe'
});
...
var vmAnalytics = new Vue({
    ...
    methods:{
        ...
        mapAnalysisResult:function(){
            ...
            // Add some base tiles
            var anMapboxTerrain = L.tileLayer('https://api.mapbox.com/styles/v1/msfhk/cj9t3um812mvr2sqnr6fe0h52/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibXNmaGsiLCJhIjoiY2pxdnp0N3E2MTBwZDQybWhtMGw2aWljYSJ9.I6nmYZcm6p77JgxlITRfpQ', {
                attribution: '© Mapbox © OpenStreetMap © DigitalGlobe',
                minZoom: 0,
                maxZoom: 18
            });

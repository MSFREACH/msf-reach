...
var loadMissions = function(err, missions){
  if (err){
    ...
    $.each(missions, function(key, value){
      $('#missionsTable').append('<tr><td>'+value.properties.properties.name+'</td><td>'+value.properties.properties.region+value.properties.properties.startDate+'</td><td>'+value.properties.properties.endDate+'</td><td>'+value.properties.properties.severity+'</td><td>'+value.properties.properties.capacity+'</td></tr>');
    })
